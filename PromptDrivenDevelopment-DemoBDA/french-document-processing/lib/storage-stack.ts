...
export class StorageStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    this.rawDocumentsBucket = new s3.Bucket(this, 'RawDocumentsBucket', {
      ...
      removalPolicy: RemovalPolicy.RETAIN, // Prevent accidental bucket deletion
    });
    ...
    new cdk.CfnOutput(this, 'RawDocumentsBucketName', {
      ...
      exportName: 'FrenchDocProcessingRawDocumentsBucketName'
    });
    ...
    new cdk.CfnOutput(this, 'ProcessedDocumentsBucketName', {
      ...
      exportName: 'FrenchDocProcessingProcessedDocumentsBucketName'
    });
    ...
    new cdk.CfnOutput(this, 'DocumentMetadataTableName', {
      ...
      exportName: 'FrenchDocProcessingDocumentMetadataTableName'
    });
    ...
    new cdk.CfnOutput(this, 'VerificationResultsTableName', {
      ...
      exportName: 'FrenchDocProcessingVerificationResultsTableName'
    });
    ...
    new cdk.CfnOutput(this, 'FaceMetadataTableName', {
      ...
      exportName: 'FrenchDocProcessingFaceMetadataTableName'
    });
    
    new cdk.CfnOutput(this, 'SessionTableName', {
      value: this.sessionTable.tableName,
      description: 'The name of the DynamoDB table for session tracking',
      exportName: 'FrenchDocProcessingSessionTableName'
    });
  }
}